...
urlpatterns = [
    ...
    path('dashboard/metrics/', dashboard_metrics.dashboard_metrics, name='dashboard_metrics'),
    path('dashboard/metrics/<int:metric_id>/', dashboard_metrics.detalle_ejecucion, name='detalle_ejecucion'),
] 