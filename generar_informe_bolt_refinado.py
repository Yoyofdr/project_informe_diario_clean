#!/usr/bin/env python
"""
Script para generar el informe del Diario Oficial con diseño Bolt refinado
Versión final con fechas en español y referencia a la fuente oficial
"""
import os
import sys
import django
...
def generar_informe_html(fecha):
    ...
    print(f"Generando informe Bolt refinado para: {fecha}")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        fecha_hoy = "12-07-2025"
    
    html = generar_informe_html(fecha_hoy)
    
    # Guardar el HTML
    filename = f"informe_bolt_refinado_{fecha_hoy.replace('-', '_')}.html"
    with open(filename, "w", encoding="utf-8") as f:
        f.write(html)
    
    print(f"\nInforme generado: {filename}")
    print(f"Diseño Bolt refinado con:")
    print("- Degradados sutiles")
    print("- Toques azules en estadísticas")
    print("- Fecha en español")
    print("- Referencia a la fuente oficial")