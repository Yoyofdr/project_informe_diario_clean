#!/usr/bin/env python
"""
Script para generar el informe del 21 de julio con el diseño correcto de email
"""
from datetime import datetime

def generar_informe_correcto():
    """Genera el informe del 21 de julio con el diseño de email correcto"""
    
    # Generar HTML con diseño de email
    html = """<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
if __name__ == "__main__":
    html = generar_informe_correcto()
    
    # Guardar el HTML
    filename = "informe_diario_oficial_21_07_2025_email.html"
    with open(filename, "w", encoding="utf-8") as f:
        f.write(html)
    
    print(f"Informe con diseño correcto generado: {filename}")