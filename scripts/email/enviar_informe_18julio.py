#!/usr/bin/env python
"""
Script para enviar el informe del 18 de julio por correo
"""
import os
import sys
import django
...
try:
    ...
    print("- Proceso de consulta previa pueblo mapuche (múltiples regiones)")
    print("- Fomento a la inversión privada en obras de riego (Ley 18.450)")
