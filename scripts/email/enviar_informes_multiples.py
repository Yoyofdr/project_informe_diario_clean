#!/usr/bin/env python
"""
Script para enviar múltiples informes del Diario Oficial
"""
import os
import sys
import django
...
# Ejecutar
fechas = ["11-07-2025", "13-07-2025", "14-07-2025", "15-07-2025", "16-07-2025", "17-07-2025"]
recipient = 'rfernandezdelrio@uc.cl'

print(f"📧 Enviando {len(fechas)} informes a {recipient}...")
print("="*50)
...
for fecha in fechas:
    try:
        ...
        # Enviar
        msg.send()
        print(f"✓ {fecha} - Enviado exitosamente")
        informes_enviados += 1
        ...
        informes_fallidos.append(fecha)

print("\n" + "="*50)
print(f"📊 RESUMEN:")
print(f"   ✓ Enviados: {informes_enviados}/{len(fechas)}")
if informes_fallidos:
    print(f"   ✗ Fallidos: {', '.join(informes_fallidos)}")
print("="*50)